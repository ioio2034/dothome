...
?>
	...
	<footer id="colophon" class="site-footer container" role="contentinfo">
		...
		<div class="site-info container">
			<?php printf(esc_html__('Copyright %1$s %2$s %3$s', 'minalite'), '&copy;', esc_attr(date_i18n(__('Y', 'minalite'))), esc_attr(get_bloginfo())); ?>
                <span class="sep"> &ndash; </span>
            <?php printf(esc_html__('%1$s Designed & Developed by %2$s', 'minalite'), '', '<a href="' . esc_url('https://zthemes.net/', 'minalite') . '">ZThemes.</a>'); ?>
		</div><!-- .site-info -->
